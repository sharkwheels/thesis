...
def send_to_calendar(eventDeets):
	...
	d["value1"] = eventDeets
	try:
		requests.post("https://maker.ifttt.com/trigger/cal_event/with/key/{0}".format(IFTTT_KEY), data=d)
		print("sent")
	except:
		print("nope")
...
def no_intent():
	...
	badger_resps = [
		...
		"let's hang out. We can order something in and watch Defenders!",
		"let's stay in and order pizza. You like pineapple as a topping, right?",
		"let's spend some time together and drink some wine? I know some good ones."
	]
	...
	if bc >= 2:
		return question("Y'know, I'm not going to stop until you say yes, right?")
	else:
